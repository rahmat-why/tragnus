...
const transformConversations = ({ conversations, profiles, }) => conversations.map(conversation => {
    const participants = (0, lodash_1.map)(conversation['*participants'], participant => {
...
class ConversationRepository {
    ...
    async getConversation({ conversationId }) {
        ...
        const profiles = (0, profile_repository_1.getProfilesFromResponse)(response);
    ...
    async fetchConversations({ recipients, createdBefore, }) {
        ...
        const profiles = (0, profile_repository_1.getProfilesFromResponse)(res);
        return (0, lodash_1.orderBy)(transformConversations({ conversations, profiles }), 'lastActivityAt', 'desc');
    }
}
